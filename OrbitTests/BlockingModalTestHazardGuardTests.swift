// Fails, naming file and line, on any call to a blocking AppKit modal API (popUp,
// runModal, etc.) as code, not comment -- it hangs an unattended run. Opt out with a
// same-line "ORBIT-BLOCKING-MODAL-SELF-TERMINATES: <why>" marker.
...
final class BlockingModalTestHazardGuardTests: XCTestCase {
    ...
    func testNoTestSourceCallsABlockingAppKitModalAPIUnexempted() throws {
        ...
        XCTAssertTrue(
            ...
            `buildNativeContextMenu` vs `presentNativeContextMenu`, and \
