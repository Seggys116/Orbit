//  NSPrincipalClass fails silently when misconfigured — XCTest never instantiates
//  ModalHangGuardPrincipalClass and the watchdog this bundle believes it has isn't there.
